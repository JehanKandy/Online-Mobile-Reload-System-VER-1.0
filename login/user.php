...
<nav class="navbar navbar-dark bg-dark">
    <a class="navbar-brand" href="#">JK Online Mobile Reload - User Panel &nbsp&nbsp <?php echo $email; ?></a> 
...
<div class="container">
    ...
    <div class="card-body">
        ...
        <p class="card-text">
            ...
            <td>
                <a href="balance.php" style="text-decoration: none;">
            ...
            <td>
                <div class="card bg-light mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><a href="recharge.php"><button class="btn btn-success">Add Balance</button></a></p>
                    </div>
                </div>
            </td>
            <td>
            ...
            <td>
                <div class="card bg-light mb-3" style="max-width: 25rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><a href="reload.php"><button class="btn btn-success">Reload</button></a></p>
                    </div>
                </div>
            </td>
        </tr>
